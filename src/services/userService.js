...
const getAllDetialSpecialtyById = (data) => {
...
const getAllDetialClinicById = (data) => {
...
export {
    ...
    createNewSpecialty, getAllSpecialty, getAllDetialSpecialtyById,
    createNewClinic, getAllClinic, getAllDetialClinicById
